...
public class OrderServiceImpl implements OrderService {
    ...
    public PageResult pageQuery(OrdersPageQueryDTO ordersPageQueryDTO) {
        ...
        for (OrderVO order : records) {
            order.setOrderDetailList(
                    detailMap.getOrDefault(order.getId(), new ArrayList<>())
            );
        }
    ...
    public void rejection(OrdersRejectionDTO ordersRejectionDTO) throws Exception {
        // 根据id查询订单
        Orders ordersDB = orderMapper.getById(ordersRejectionDTO.getId().toString());
    ...
    public void cancel(OrdersCancelDTO ordersCancelDTO) throws Exception {
        // 根据id查询订单
        Orders ordersDB = orderMapper.getById(ordersCancelDTO.getId().toString());
    ...
    public void delivery(Long id) {
        // 根据id查询订单
        Orders ordersDB = orderMapper.getById(id.toString());
    ...
    private String getOrderDishesStr(Orders orders) {
        ...
        List<OrderDetail> orderDetailList = orderDetailMapper.getByOrderId(orders.getId().toString());
